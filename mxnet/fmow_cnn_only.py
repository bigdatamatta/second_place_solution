...
from common import data_cnn as data
from common import fit_cnn as fit
...
if __name__ == "__main__":
    ...
    parser.set_defaults(image_shape='3,280,280', num_epochs=8,
                        lr=.01, lr_step_epochs='7', wd=0, mom=0)
